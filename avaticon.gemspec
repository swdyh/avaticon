...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "ChangeLog", "Rakefile", "test/avaticon_test.rb", "test/html", "test/html/flickr_kusaker", "test/html/github_kzys", "test/html/hatena_swdyh", "test/html/lastfm_youpy", "test/html/nowa_yuiseki", "test/html/twitter_swdyh", "test/html/wassr_kotoriko", "test/test_helper.rb", "lib/avaticon.rb"]
  s.has_rdoc = true
